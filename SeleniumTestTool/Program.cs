...
namespace SeleniumTestTool
{
    class Program
    {
        ...
        {//Web tabanlı sistemlerde testleri yapmak için geliştirilmiş bir test aracıdır veya kütüphanedir.
            ...
            //    driver.FindElement(By.Id("email")).SendKeys("alisari41@outlook.com");// SendKesys() komudu ile değer gönderilecek

            //    //Şifre textbox'ın id=password bilgisi
            //    driver.FindElement(By.Id("password")).SendKeys("123456*");// SendKesys() komudu ile değer gönderilecek
            ...
            driver.FindElement(By.XPath("//*[@id='contentListing']/div/div/div[1]/div[6]/a[2]")).Click(); // XPath bütün sayfa içinde arama yapan bir cümlecik
            ...
            Thread.Sleep(9000);//Bekleme süresi koyuyyorum sayfa yüklensin yoksa patlıyor
